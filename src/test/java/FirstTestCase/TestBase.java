...
public class TestBase {
    ...
    public void setUp() {
        ...
        capabilities.setCapability("videoName", "ExpressTrattoriaTestCaseForFirstSendOrder.mp4");
        capabilities.setCapability("name", "ExpressTrattoriaTestCaseForFirstSendOrder");
    ...
    @Step("Открываю сайт")
    public void openURL() {
        open("https://express-trattoria.ru/");
    }
    ...
    public void mathRandomHead() {
        List<SelenideElement> mathRandomHead = elements(By.xpath("//a[contains(@class, \"scroll-nav_link\") and not (@href = \"/menu/pizza\") and not (@href = \"/menu/stritfud\") and not (@href = \"/menu/kaltsone\") and not (@href = \"/menu/nabory\") and not (@href = \"/menu/kukhnya-2\") and not (@href = \"/menu/pizza-constructor\")]"));
